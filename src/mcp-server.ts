...
- **update-tasks**: Modify existing tasks - get task IDs from search results first, only include fields that need changes. Supports due date updates via dueString and due date removal via "dueString: remove". Also supports deadlineDate (ISO 8601 format like "2025-12-31") updates and removals via "deadlineDate: remove"
